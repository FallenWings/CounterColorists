...
GameGraphics::~GameGraphics()
{
	...
	delete guiRenderListDraw;
	delete guiTextureManager;
	delete worldRenderList;
	delete worldRenderListDraw;
...
/*
   Swapping the rend list to seprate the work for render thread
*/
void GameGraphics::swapRenderLists(){
	//for gui render list
	RenderList* guiTemp = guiRenderListDraw;
    guiRenderListDraw = guiRenderList;
	guiRenderList = guiTemp;

   //for world render list
	RenderList* worldTemp = worldRenderListDraw;
    worldRenderListDraw = worldRenderList;
	worldRenderList = worldTemp;
