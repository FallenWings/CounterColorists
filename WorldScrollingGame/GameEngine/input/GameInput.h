...
protected:
	...
	**/
	...
	struct GamepadInputState
	{
		...
		bool isGamepadFirstPressed;
		bool wasGamepadHeldDown;
	} gamepadState[30];
...
public:
	...
	bool	isGamepadDown(int gamepadKey)
	{	return gamepadState[gamepadKey].isGamepadPressed; }

	bool	isGamepadDownForFirstTime(int gamepadKey)
	{	return gamepadState[gamepadKey].isGamepadFirstPressed; }
